...
<p align="center">
  <i>Transformando requerimientos complejos en código limpio, escalable y eficiente.</i>
</p>
...
* Especialista en arquitecturas sólidas, dominando el desarrollo tanto en el Frontend como en el Backend.
* Destaco en la estructuración, consumo y creación de **APIs RESTful** mediante **JSON**.
* Poseo un dominio profundo de bases de datos relacionales para manejar y optimizar grandes volúmenes de información.
* Mantengo un enfoque estricto en el rendimiento, la seguridad de los datos y la experiencia del usuario final.
